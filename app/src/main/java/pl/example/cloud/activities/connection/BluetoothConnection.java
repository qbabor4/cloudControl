package pl.example.cloud.activities.connection;
...
import pl.example.cloud.cloudcontrol.CloudController;
import pl.example.cloud.cloudcontrol.EDefaultData;
import com.example.cloud.cloudcontrol.R;
import pl.example.cloud.device.CloudDevice;
