...
import pl.example.cloud.activities.connection.BluetoothConnection;
import pl.example.cloud.activities.connection.ConnectionService;

import com.example.cloud.cloudcontrol.R;

import pl.example.cloud.device.CloudDeviceActionsImpl;
import pl.example.cloud.device.ICloudDeviceActions;

import java.io.IOException;

import static pl.example.cloud.cloudcontrol.Settings.PREFS_NAME;
import static pl.example.cloud.cloudcontrol.Settings.PREF_DARK_THEME;
...
//                mCloudDevice.sendColor(ERgbColors.BLACK.getColor());
